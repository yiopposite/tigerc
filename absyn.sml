...
fun varToString(SimpleVar(s,_)) = "SimpleVar(" ^ Symbol.name s ^ ")"
  | varToString(FieldVar(v,s,_)) = "FieldVar(" ^ varToString(v) ^ ", " ^ (Symbol.name s) ^ ")"
  | varToString(SubscriptVar(v,e,_)) = "SubscriptVar(" ^ varToString(v) ^ ",*EXP*)"
